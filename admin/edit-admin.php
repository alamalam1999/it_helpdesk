...
<?php } ?>
      ...
      <section id="content">
        ...
        if (!empty($_FILES["nama_file"]["tmp_name"]))
        {
          ...
          $update = mysqli_query($koneksi, "UPDATE user SET username='$username', password='$password', fullname='$fullname', no_hp='$no_hp', level='$level' ,gambar='$gambar' WHERE user_id='$kd'") or die(mysqli_error());
