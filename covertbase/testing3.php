 ...
 include "conn.php";
	...
	{ 
		//echo "Email berhasil terkirim!";  
				...
				if(mysqli_num_rows($cek) == 0){
						$insert = mysqli_query($koneksi, "INSERT INTO tiketdg(id_tiket,waktu, tanggal, pc_no, nama, nomor, email, departemen, jenis ,video ,tanggal, deadline , problem, penanganan, status, filename)
															VALUES('$id_tiket','$waktu','$tanggal','$pc_no','$nama','$nomor','$email','$departemen','$jenis','$video','$tanggal','$deadline','$problem','$none','$open','$filename')") or die(mysqli_error());
						if($insert){
	...
	<form class="cd-form floating-labels" method="POST" enctype="multipart/form-data" action="dashboard.php">
		<fieldset>
            ...
            //'$id_tiket','$waktu','$tanggal','$pc_no','$nama',$nomor,'$email','$departemen','$jenis','$video','$tanggal','$deadline','$problem','$none','$open','$filename'
            ...
            <input type="hidden" name="pc_no" value="desain grafis" id="desain"/>
		    ...
		    <div class="icon">
                ...
                <input name="tanggal" type="date" class="email form-control" id="customFile" />
            </div> 
            ...
            <div class="icon">
		     ...
		     <div class="icon">
				...
				<input class="user" type="text" name="kegiatan" id="nama"  required="required">
		    </div> 
